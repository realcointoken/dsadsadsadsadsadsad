...
import { Button, CalculateIcon, Flex, FlexProps, Skeleton, useModal } from 'uikit'
...
const Apr: React.FC<AprProps> = ( { pool, showIcon, stakedBalance, performanceFee = 0, ...props } ) => {
  ...
  const apyModalLink = stakingToken.address ? `${ BASE_SWAP_URL }?outputCurrency=${ stakingToken.address }` : BASE_SWAP_URL
