...
import { addSerializedPair, addSerializedToken, addWatchlistPool, addWatchlistToken, FarmStakedOnly, muteAudio, removeSerializedPair, removeSerializedToken, SerializedPair, toggleTheme, unmuteAudio, updateGasPrice, updateUserDeadline, updateUserExpertMode, updateUserExpertModeAcknowledgementShow, updateUserFarmStakedOnly, updateUserFarmsViewMode, updateUserPoolStakedOnly, updateUserPoolsViewMode, updateUserPredictionAcceptedRisk, updateUserPredictionChartDisclaimerShow, updateUserSingleHopOnly, updateUserSlippageTolerance, updateUserUsernameVisibility, ViewMode } from './actions'
